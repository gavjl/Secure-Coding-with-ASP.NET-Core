...
public class IdentityDbContext : IdentityDbContext<GloboSurveyUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        GloboSurveyUser roleUser = CreateUser(
        ...
        GloboSurveyUser claimUser = CreateUser(
    ...
    private GloboSurveyUser CreateUser(string email, string name, DateTime dob, Guid id)
    {
